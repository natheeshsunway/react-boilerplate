...
const AsyncIncrement = Loadable({
  loader: () => import('~components/examples/router/routes/IncrementRoute'),
  loading() {
...
const AsyncDecrement = Loadable({
  loader: () => import('~components/examples/router/routes/DecrementRoute'),
  loading() {
    return <Icon icon="cog fa-spin" />;
  },
});
...
const AsyncReset = Loadable({
  loader: () => import('~components/examples/router/routes/ResetRoute'),
  loading() {
    return <Icon icon="cog fa-spin" />;
  },
});

const AsyncTabbedRouter = ({ location, history }) => {
  return (
